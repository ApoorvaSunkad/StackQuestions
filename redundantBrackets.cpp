...
else return false. The given string only 
...
For Example :
((a+b)) has a pair of redundant brackets. The pair of brackets on the first and 
last index is needless. 
...
In the first test case, there are no redundant brackets. Hence, the output 
is “No”. 
...
In the second test case, the brackets around the subexpression “(a+b)” 
( index 0 and index 6) are redundant. Hence the output is “Yes”.
